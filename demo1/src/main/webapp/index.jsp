...
<div class="row px-5 header align-items-center bg-light fixed-top shadow-sm">
    <div class="text-center text-danger h1">Product Discount Calculator</div>
</div>
        ...
        <div class="col-5 border border-primary shadow p-3 mb-5 bg-body rounded fill-form-register p-5">
            <form action="/display-discount" method="post">
                ...
                <div class="form-outline mt-3">
                    ...
                    <label class="form-label" for="price">List Price</label>
                </div>
                <div class="form-outline mt-3">
                ...
                <div class="button-submit text-center mt-3">
                    <button type="submit" class="btn btn-primary btn-rounded mt-3 ">Submit</button>
                </div>
            </form>
        </div>
    </div>
